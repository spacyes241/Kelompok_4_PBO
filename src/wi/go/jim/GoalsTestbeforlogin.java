 ...
 */
public class GoalsTestbeforlogin extends javax.swing.JFrame {
    ...
    private void buttonloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonloginActionPerformed
        ButtonSignUpSignIn addForm = new ButtonSignUpSignIn(GoalsTestbeforlogin.this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GoalsTestbeforlogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GoalsTestbeforlogin().setVisible(true);
            }
        });
    }
