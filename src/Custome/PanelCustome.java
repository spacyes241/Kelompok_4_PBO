 ...
 */
public class PanelCustome extends JPanel  {
    ...
    public int getRoundTBottomRight() {
        return roundBottomRight;
    }

    public void setRoundTBottomRight(int roundTBottomRight) {
        this.roundBottomRight = roundTBottomRight;
    }
